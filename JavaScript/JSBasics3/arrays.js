    ...
    //Basic Operations on JavaScript Arrays
     ...
     // B.)Objects/Refrences
      ...
      //To remove the elements from an array we have different methods like pop(), shift(), or splice().
         ...
         // 3.) splice (), The splice() method removes or replaces the element from the array.
      ...
      // 18.) Mapping an objects------------------------------------
         ...
         //converting into arrow functions
         let numb1 = filteredss.map (marking => {value: marking});
         console.log(numb1);
      ...
      // 20.) Reducing an Array-------------------------------------------
         ...
         let arr2 = [-1, -2, -3, -4];
         let totalSum1 = arr2.reduce((accumulator, currentvalue) => accumulator + currentvalue, 0)
         console.log("PRINTING TOTAL SUM:");
